...
function Queue () {
    ...
    function enqueue(item){
        ...
        console.log('e storage[front]', storage[front]);
        console.log('e storage[back]', storage[back]);
    ...
    function dequeue() {
        if (back > 0) {
            ...
            console.log('d if let first =', first);
            console.log('d size', size());
            console.log('d front before', front);
            console.log('d back before', back);
            console.log('d if storage[front]', storage[front]);
            console.log('d if storage[back]', storage[back]);
            ...
            console.log('d if storage[front] after', storage[front]);
            console.log('d if storage[back] after', storage[back]);
            console.log('');
            ...
            console.log('d else back is null', back);
            console.log('d else rtn front', front);
            return front;
        }
