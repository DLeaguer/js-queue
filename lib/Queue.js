...
class Queue {
    constructor () {
        ...
        this._front = null;
        // console.log('tfront ', this._front);
        this._back = null;
        // console.log('tback ', this._back);
        // this._size = 0;
        // console.log('tsize ', this_size);
    }
    size() {
        if (this._back === null) {
            this._back = 0;
    ...
    enqueue(item) {
        ...
        if (this._back === null) {
            ...
            // console.log('storage before', this._storage);
            this._storage[this._back] = item;
            this._back++;
            // console.log('storage after', this._storage);
            return this.size();
        }
    }
    dequeue() {
        if (this._back === null) {
            ...
            let deleted = this._storage[this._front];
